...
*This is unconvient. If I could use an input, I could set an onChange event handler to clear the display after x sec.*
*Also bugged, when I add a class to simulate a transition on keyboard input, it fails the test.*
